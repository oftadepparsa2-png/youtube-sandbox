...
این مخزن با استفاده از **GitHub Actions** بهت اج ازه می‌ده که فقط ا **ارسال لینک یوتیوب توی پیام کامیت**، ویدیو به‌صورت خودکار دانلود بشه و توی مخزن ذخیره بشه.
     
ایده اصلی این بود که بدون نیاز به فیلترشکن و کانفیگ‌های گرون، بتونیم ویدیوها  مورد علاقه‌م ون رو ذخیره کنیم. فقط کافیه لینک  یو رو کپی کنی و با این اکشن  دانلودش کنی.
